...
name: Sebastian
surname: Rowan
position: "ORISE Postdoctoral Research Fellow"
# pronouns: He/Him
address: "USACE ERDC Coastal and Hydraulics Laboratory, Vicksburg, MS"
...
orcid: false
aboutme: |
  I am postdoctoral research fellow studying the impacts of flood events and climate change on people and communities. The goal of my research is to develop a more comprehensive understanding of the risks posed by floods to enable the development of mitigation efforts that prioritize long-term sustainability and community well-being.
...
tribble(
  ...
  "Ph.D., Civil and Environmental Engineering", "September 2026", "University of New Hampshire", "Durham, New Hampshire",
  list(
    "Dissertation Title: Quantifying Greenhouse Gas Emissions and Mental Health Impacts as Co-Benefits of Flood Risk Mitigation",
    "Advisor: Dr. Weiwei Mo"
  ),
...
tribble(
  ...
  "ORISE Postdoctoral Research Fellow", "U.S. Army Corps of Engineers, Engineer Research Development Center", "Vicksburg, MS", "Sep. 2026 - Present",
  list(),
  
  "ORISE Graduate Research Fellow", "U.S. Army Corps of Engineers, Engineer Research Development Center", "Vicksburg, MS", "Sep. 2020 - Sep. 2026",
  list(
    "Contributed to the development of USACE'S \"go-consequences\" flood consequence analysis tool.",
...
**Rowan, S.**, Yeates, E. **(In Review)**. The effects of home damage on post-flood mental health: A systematic review and meta-analysis. _Natural Hazards Review_

Qiao, Y., Guo, Y., **Rowan, S.**, Medina, R., Espinet, X., Cullen, J., Meng, F., Cao, Z. (2026). Doubling of flood-induced bridge asset failure loss in Mozambique under 2050 climate. _Global Environmental Change_, https://doi.org/10.1016/j.gloenvcha.2025.103103
...
Yeates, E., **Rowan, S.**, Bledsoe, B. Reconciling Flood Risk Management with Systemic Environmental Hazards. *AEES 2026 Annual Meeting; June 2026; Burlington, VT.* Poster.
