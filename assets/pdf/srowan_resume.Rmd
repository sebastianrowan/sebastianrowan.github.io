...
tribble(
  ...
  list(
    "(RA) Resilient Bridge Planning in Mozambique - Bridge Failure Risk from Flooding and Climate Change\n\t- Worked with stakeholders from the World Bank and the Mozambique National Roadway Agency to quantify flood risk posed to Mozamibique's national bridge portfolio under current and future climate projections using \\textbf{R, Python, and QGIS}",
