# Sebastian Rowan's personal website

This is the repository for the personal site of Sebastian Rowan, which can be viewed at [sebastianrowan.github.io](sebastianrowan.github.io). This website was designed using the "al-folio" theme for academics [template](https://github.com/alshedivat/al-folio). 
